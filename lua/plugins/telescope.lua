return {
  ...
  keys = {
    ...
    { "<leader>fc", function() require("telescope.builtin").find_files({ cwd = vim.fn.stdpath("config") }) end, desc = "Telescope: Find Config File" },
    ...
    { "<leader>sd", "<cmd>Telescope diagnostics<cr>", desc = "Telescope: Diagnostics" },
